 ...
 *
 * Coloured from the active theme (`chrome.primary`/`accent`), not a fixed
 * hue, so it never clashes with the header/footer band.
 */
function BilbyFigure({ size, main, accent }: { size: number; main: string; accent: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 220 260">
      ...
      />
      {/* back foot */}
      <Ellipse cx={140} cy={244} rx={20} ry={11} fill={main} />
      {/* body */}
      <Ellipse cx={100} cy={190} rx={54} ry={62} fill={main} />
      <Ellipse cx={96} cy={205} rx={32} ry={38} fill={palette.cream} opacity={0.9} />
      {/* front foot */}
      <Ellipse cx={70} cy={246} rx={18} ry={10} fill={main} />
      {/* arms */}
      <Ellipse cx={48} cy={170} rx={13} ry={26} fill={main} transform="rotate(18 48 170)" />
      {/* ears */}
      <Ellipse cx={58} cy={58} rx={20} ry={34} fill={main} transform="rotate(-20 58 58)" />
      <Ellipse cx={122} cy={58} rx={20} ry={34} fill={main} transform="rotate(20 122 58)" />
      <Ellipse cx={58} cy={62} rx={10} ry={20} fill={accent} transform="rotate(-20 58 62)" />
      <Ellipse cx={122} cy={62} rx={10} ry={20} fill={accent} transform="rotate(20 122 62)" />
      {/* head */}
      <Circle cx={90} cy={104} r={52} fill={main} />
      ...
      {/* cheeks */}
      <Circle cx={58} cy={116} r={7} fill={accent} opacity={0.5} />
      <Circle cx={122} cy={116} r={7} fill={accent} opacity={0.5} />
    </Svg>
  );
}
...
export function BilbyMascot() {
  ...
  return (
    <View style={styles.corner} pointerEvents="none">
      <BilbyFigure size={260} main={chrome.primary} accent={chrome.accent} />
    </View>
  );
}
